...
(function (root, factory) {
  ...
  var GAMES = [
    ...
    },
    {
      ...
      highlights: ["เล่นคนละเครื่อง", "ระบบนับวิธีทั้งหมดให้", "มีระบบกันโกงตอนเถียงกัน"],
      accent: "gold"
    },
    {
      id: "guess-thing",
      ...
      highlights: ["เล่นคนละเครื่อง", "มีโหมดเล่นคนเดียวสู้ AI", "มีชุดคำสำเร็จรูปให้เลือก"],
      accent: "hot"
    },
    {
      id: "spyfall",
      emoji: "🕵️",
      name: "สายลับ",
      tagline: "หาสายลับที่ไม่รู้ว่าตัวเองอยู่ที่ไหน",
      players: { min: 3, max: 12, sweet: "4–8 คน" },
      minutes: "8 นาทีต่อรอบ",
      href: "/spyfall.html",
      description:
        "ทุกคนอยู่สถานที่เดียวกันและรู้ว่าที่ไหน ยกเว้นสายลับหนึ่งคนที่ไม่รู้อะไรเลย " +
        "ถามตอบกันเพื่อหาสายลับ ส่วนสายลับต้องเดาให้ออกว่าที่นี่คือที่ไหน",
      highlights: ["96 สถานที่ บทบาทละ 7 แบบ", "เล่นคนละเครื่อง", "จับเวลา 8 นาทีตามต้นฉบับ"],
      accent: "volt"
    },
    {
      id: "werewolf",
      emoji: "🐺",
      name: "หมาป่า",
      tagline: "กลางคืนล่า กลางวันล่าแม่มด",
      players: { min: 5, max: 16, sweet: "7–12 คน" },
      minutes: "20–40 นาที",
      href: "/werewolf.html",
      description:
        "กลางคืนหมาป่าออกล่า กลางวันชาวบ้านโหวตประหาร " +
        "แอปเป็นคนคุมเกมให้เอง ทุกคนได้เล่นครบไม่ต้องมีใครเสียสละมานั่งคุม",
      highlights: ["14 บทบาท จัดชุดเองได้", "มีเซ็ตแนะนำให้เลือก", "ตายแล้วไม่เฉลยบทบาท"],
      accent: "hot"
    },
    {
      id: "chain",
      ...
      highlights: ["เล่นคนละเครื่อง", "ตรวจคำซ้ำภาษาไทยให้อัตโนมัติ", "ระบบชาเลนจ์และโหวต"],
      accent: "volt"
    }
  ];
